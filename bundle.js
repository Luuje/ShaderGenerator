...
var interval = 1000 / 60; // For 60 frames per second
var lastTime = 0;
var startTime = Date.now() * 0.001; // Initialize start time in seconds
var programInfo;
if (!gl) {
  alert('Unable to initialize WebGL. Your browser may not support it.');
}
function loadShaderFile(_x) {
  return _loadShaderFile.apply(this, arguments);
}
function _loadShaderFile() {
  _loadShaderFile = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(url) {
    var response;
...
function _init() {
  _init = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var vertexShaderSource, fragmentShaderSource, shaderProgram, buffers, render;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          render = function _render(now) {
          ...
          _context3.next = 3;
          return loadShaderFile('vertexShader.glsl');
        case 3:
          vertexShaderSource = _context3.sent;
          _context3.next = 6;
          return loadShaderFile('fragmentShader.glsl');
        case 6:
          fragmentShaderSource = _context3.sent;
...
function drawScene(gl, progInfo, buffers, elapsedTime) {
  ...
  gl.vertexAttribPointer(progInfo.attribLocations.vertexPosition, 2, gl.FLOAT, false, 0, 0);
...
function initInputButton() {
  document.getElementById('sendButton').addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var userInput, response, data;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.prev = 2;
          _context.next = 5;
          return fetch('http://localhost:3000/api/openai', {
            method: 'POST',
            headers: {
...
function updateShader(_x2) {
  return _updateShader.apply(this, arguments);
}
function _updateShader() {
  _updateShader = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(glslCode) {
    var isFragmentShader, vertexShaderSource, fragmentShaderSource, shaderProgram;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          isFragmentShader = true; // Set this based on the response or user input
        ...
        case 8:
          _context4.t0 = null;
        case 9:
          vertexShaderSource = _context4.t0;
          if (!isFragmentShader) {
            _context4.next = 14;
            break;
          }
          _context4.t1 = glslCode;
          _context4.next = 17;
          break;
        case 14:
          _context4.next = 16;
        ...
        case 17:
          fragmentShaderSource = _context4.t1;
